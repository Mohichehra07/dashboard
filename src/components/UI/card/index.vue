...
<template>
    <div class="w-[250px] h-[150px] bg-gradient-to-r from-[#EAABF0] to-[#4623E9] rounded-3xl p-7 ">
        <h4 class="w-[183px] h-[42px] text-[14px] text-[white] text-center">Upgrade to  PRO to get access all Features!</h4><br>
