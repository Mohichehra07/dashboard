...
import { tableHealders,tableRow } from '../../../constanta/index';
</script>
<template>      
<div class="flex gap-[112px] pt-6 pl-4">
    <div class="w-[218px] h-20 flex gap-5">
            <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M50.7172 28.9996C54.1122 28.9996 56.8422 31.7471 56.8422 35.1246C56.8422 38.4321 54.2172 41.1271 50.9447 41.2496C50.8047 41.2321 50.6472 41.2321 50.4897 41.2496" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div>
                <h3 class="text-[14px] text-[#ACACAC]">Total Customers</h3>
        <strong> <h1 class=" text-[32px]">5,423</h1> </strong>
        <div class="flex">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 17L10 5" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M4.16666 9.99999L10 4.16666L15.8333 9.99999" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <p class="text-[#00AC4F] text-[12px]">16%</p>
                <p class="text-[12px]">this month</p>
        </div>
    </div>
    </div>
    <div class="w-[218px] h-20 flex gap-5">
        <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
            <h3 class="text-[14px] text-[#ACACAC]">Members</h3>
    <strong> <h1 class=" text-[32px]">1,893</h1> </strong>
    <div class="flex">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 3L10 15" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M15.8333 10L10 15.8333L4.16668 10" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <p class="text-[#D0004B] text-[12px]">1%</p>
            <p class="text-[12px]">this month</p>
    </div>
    </div>
    </div>
